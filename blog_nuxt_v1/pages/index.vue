      ...
      <div v-for="post in posts" :key="post.slug" class="col-md-4">
        ...
        <div class="card mb-4 shadow-sm">
          ...
          <div class="card-body">
            ...
            <!-- Вывод форматированногог текста -->
...
export default {
  watchQuery: ['page'],
  computed: {
    ...mapState('index_page', ['posts', 'total', 'next', 'previous', 'current_page']),
  },
  async fetch({store, route}) {
    await store.dispatch('index_page/loadAllPosts', {query_page: route.query.page})
  },
  head() {
    return {
